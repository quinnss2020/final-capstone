...
VALUES (101, 100, 100, 1, 'AA0000', 'Columbus', '5x5', 1, '2024-04-13 11:08:10', GETDATE())
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created) 
...
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created) 
VALUES (112, 65, 65, 1, 'FF0005', 'Cleveland', '10x10', 1, '2024-04-22 12:08:10', GETDATE())
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created) 
VALUES (113, 90, 90, 2, 'GG0006', 'Cincinnati', '10x15', 1, '2024-04-13 11:08:10', GETDATE())
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created) 
VALUES (201, 120, 120, 3, 'HH0007', 'Akron', '10x20', 1, '2024-04-12 12:48:10', GETDATE())
