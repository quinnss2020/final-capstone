...
VALUES (101, 100, 100, 1, 'AA0000', 'Columbus', '5x5', 1, '2024-04-20 10:30:10', GETDATE(), 'Well-loved furniture assortment: A mishmash of worn sofas, chipped dining sets, and mismatched lamps, perfect for DIY enthusiasts looking to refurbish or repurpose these vintage pieces for a touch of character in any home.')
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
...
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
VALUES (111, 40, 40, 1, 'EE0004', 'Columbus', '5x5', 1, '2024-04-20 13:08:10', GETDATE(), 'Electronics graveyard: Outdated gadgets, cracked screens, and dusty devices from years gone by, a testament to the ever-changing landscape of technology and the memories held within each worn-out item.')
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
...
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
VALUES (113, 90, 90, 1, 'GG0006', 'Cincinnati', '10x15', 1, '2024-04-20 15:08:10', GETDATE(), 'Fashion mishmash closet: Pre-loved garments, hand-me-downs, and thrifted treasures, offering a budget-friendly way to indulge in style and self-expression while giving new life to once-loved pieces.')
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
VALUES (201, 120, 120, 3, 'HH0007', 'Akron', '10x20', 1, '2024-04-20 12:48:10', GETDATE(), 'Well-worn tool assortment: Rusty saws, dented hammers, and well-loved wrenches, a testament to the hard work and DIY projects of the past, ready to be reinvigorated by a new owner with a knack for restoration.')

INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
VALUES (202, 85, 85, 1, 'II0008', 'Columbus', '5x5', 1, '2024-04-20 18:08:10', GETDATE(), 'Kitchen odds and ends: Scratched cookware, outdated appliances, and half-used ingredients, a hodgepodge of culinary essentials perfect for those who appreciate the charm of well-loved kitchenware and budget-friendly cooking.')
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
...
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
VALUES (273, 220, 220, 1, 'KK0010', 'Cincinnati', '10x15', 1, '2024-04-20 16:38:10', GETDATE(), 'Artistic mishmash gallery: Paintings with faded colors, sculptures with chipped edges, and eclectic creations with stories to tell, offering a glimpse into the creative minds and artistic endeavors of the past.')
INSERT INTO units(local_id, start_bid, highest_bid, highest_bidder, order_number, city, size, active, expiration, created, details) 
...
INSERT INTO unit_photos(unit_id, img_URL)
VALUES(1008, 'https://res.cloudinary.com/dpicdmebf/image/upload/v1713367265/SmallStorageUnit-3-e1469712645525_nfshi7.jpg')
INSERT INTO unit_photos(unit_id, img_URL)
...
INSERT INTO unit_photos(unit_id, img_URL)
VALUES(1011, 'https://res.cloudinary.com/dpicdmebf/image/upload/v1713367334/360_F_420314895_Eu9FSsYr8rGdlKlsIo62WrewBfoSlBOp_qilr7c.jpg')
INSERT INTO unit_photos(unit_id, img_URL)
