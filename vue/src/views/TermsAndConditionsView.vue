<template>
  <div id="terms">
    <form v-on:submit.prevent="agree()">
      ...
      <p>
        By accessing and using this platform, you agree to be bound by the following terms and conditions ("Terms"). These Terms govern your use of the platform for bidding on abandoned storage units owned by Delta Storage Solutions ("Company"). </p>
<p>
1. Eligibility:
...
All storage units are sold "AS-IS" and "WHERE-IS." This means the Company makes no warranties or guarantees expressed or implied, regarding the contents, condition, or value of the unit's contents. </p>
<p>3. Bidding Process:
Unit descriptions, including size and photos (if available), are for informational purposes only and may not be entirely accurate. You are encouraged to rely solely on your own inspection of the unit's contents (when allowed) before placing a bid.
...
The winning bidder will be notified by email and must complete payment according to the instructions provided by the Company within the specified timeframe.
Payment methods will be specified for each auction and may include credit card, debit card, or cash (on-site at the facility).
The winning bidder is responsible for removing all contents from the storage unit within the designated timeframe after payment is complete.
The Company reserves the right to dispose of any unclaimed contents after the deadline.
You are responsible for any associated fees, including overdue storage charges, processing fees, and taxes related to the auction win.</p>
<p>5. Risk of Loss:
You assume all risk of loss or damage to the contents of the storage unit from the moment you win the auction.</p>
<p>6. Disclaimer of Warranties:
THE COMPANY DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND TITLE. THE COMPANY DOES NOT WARRANT THAT THE PLATFORM WILL BE UNINTERRUPTED OR ERROR-FREE.</p>
...
11. Amendment:
The Company reserves the right to amend these Terms at any time by posting the amended terms on the platform. Your continued use of the platform following the posting of amended Terms constitutes your acceptance of the amended Terms.
12. Severability:
...
14. Waiver:
No waiver of any breach of any provision of these Terms shall constitute a waiver of any other or subsequent breach.
15. Your Agreement:
By logging in to the platform, you acknowledge that you have read, understood, and agree to be bound by these Terms.
